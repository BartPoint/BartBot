...
import {
    getFileStrm
} from '../strmSupport/fileStrm.js';
import {
    clear,
    error,
    log,
    warning
} from '../consoleLog/global.js';
...
import {
    ownFiles,
    replacesUptobox
} from '../uptoboxSupport/info.js';
import {
    serveurStrm
} from '../strmSupport/info.js';
import {
    ownTheFile
} from '../uptoboxSupport/ownTheFile.js';
                ...
                fetch('https://api.alldebrid.com/v4/link/unlock?agent=' + agentName + '&apikey=' + apiKey + '&link=' + linkDecode).then(function (response) {
                    ...
                    response.text().then(function (data) {
                        ...
                        if (data.status == "success") {
                            ...
                            if (addFormat || nomFichier.match(/.*.rar.*/g) == null && nomFichier.match(/.*part[0-9].*/g) == null && nomFichier.match(/.*nfo.*/g) == null && nomFichier.match(/.*zip.*/g) == null && nomFichier.match(/.*dmg.*/g && nomFichier.match(/.*exe.*/g) == null) == null) {
